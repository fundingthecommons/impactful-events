      ...
      <Container size="lg" py="xl">
        <Stack gap="xl">
          ...
          <Paper p="xl" radius="md" withBorder>
            <Stack gap="lg">
              <Text size="lg">
                We believe the systems that govern how people coordinate — to fund, build, and sustain what matters — are the foundation of a more regenerative and equitable economy.
              </Text>
              ...
              <Text size="lg">
                As an <strong>Entrepreneur in Residence (EIR)</strong> at Commons Lab, you&apos;ll immerse yourself in our ecosystem — exploring the frontier of coordination technology, economic primitives, and collective intelligence — and identify opportunities to build a new venture within the Commons Lab network.
              </Text>
            ...
            <Stack gap="lg">
              ...
              <Stack gap="xl">
                <Card withBorder p="lg" radius="md">
                  <Stack gap="sm">
                    <Group gap="sm">
                      <Badge color="blue" variant="light">Months 0–3</Badge>
                ...
                <Card withBorder p="lg" radius="md">
                  <Stack gap="sm">
                    <Group gap="sm">
                      <Badge color="purple" variant="light">Months 3–6</Badge>
                ...
                <Card withBorder p="lg" radius="md">
                  <Stack gap="sm">
                    ...
                    <Text c="dimmed">
                      Successful ventures may spin out as independent companies with Commons Lab&apos;s support — including pre-seed investment from Commons Fund I and introductions to leading ecosystem investors.
                    </Text>
                  </Stack>
                </Card>
              </Stack>
          ...
          <Paper p="xl" radius="md" withBorder>
            <Stack gap="lg">
              ...
              <List spacing="md" icon={<IconTarget size={16} />}>
                <List.Item>
                  <Text>A founder or early-stage operator with a strong <strong>bias for action</strong> and ability to move from 0 → 1.</Text>
                </List.Item>
                <List.Item>
                ...
                <List.Item>
                  <Text>An excellent communicator — able to synthesize complex ideas into clear narratives.</Text>
                </List.Item>
              </List>
