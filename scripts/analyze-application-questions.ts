...
async function main() {
  console.log('🔍 Analyzing Application Questions for Profile Import Mapping...\n');
  ...
  console.log(`📊 Found ${questionGroups.size} unique question keys across ${questions.length} total questions\n`);
  ...
  console.log(`  🎯 Profile-relevant unmapped: ${unmappedRelevant.length} fields`);
